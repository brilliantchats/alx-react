...
describe("tests for normalized data", () => {
    it("test results array", () => {
    ...
    it("tests for normalized users", () => {
      ...
      it("tests for normalized messages", () => {
        const data = {
      ...
      it("tests for normalized notifications", () => {
        const data = {
